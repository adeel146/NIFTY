import { Menu, MenuItem, Paper, Popper, Popover, Box } from "@mui/material";
...
function MyTasks({
  ...
  console.log(overDueCountResponse);
    ...
    <>
      ...
      <div className=" w-full flex">
        ...
        <div
          ...
          className="sidebar_popup bg-white min-w-[324px] min-h-[400px] border border-gray-300 rounded px-3 m-4 mr-0 "
        >
          ...
          <div className="h-9 w-full bg-white border border-[#e8e8e8] mt-3 rounded shadow-sm">
            <span className="flex px-3 pt-[5px]">
              <svg
                className="icon  mt-[5px] mr-2 text-[#8e94bb]"
                width="1em"
                height="1em"
                viewBox="0 0 15 15"
                version="1.1"
              ...
              <input
                className="p-0 w-full border-none text-[14px] focus:outline-none focus:outline-0 focus:border-none focus:shadow-none ring-0 ring-offset-0"
                type="text"
            ...
            <ul className="mt-[20px]">
              {selectedProjects?.map((portfolio, index) => (
                <li key={portfolio.id} className="mb-1">
                  <div className=" justify-between portfolio-header flex items-center gap-[10px] text-[14px] cursor-pointer">
                    <div className="flex items-center">
                      <input
                        ...
                        className="mr-5 w-[18px] h-[18px] text-[#ccc] checked:text-[#ccc] bg-gray-100 border-gray-300 rounded dark:bg-gray-700 dark:border-gray-600 checked:bg-[#01ac9e] focus:bg-[#01ac9e] active:bg-[#01ac9e] focus:ring-teal-500 dark:focus:ring-teal-600"
                        //   disabled={index > 0}
                        onClick={(e) => {
                    ...
                    <span>
                      {expandedPortfolios.includes(portfolio.id) ? (
                        <KeyboardArrowDownIcon
                          className="text-[14px] text-[#2f2f2f]"
                          onClick={() => {
        ...
        <div className="px-[24px] py-5 flex flex-col w-full  ">
          <div
            className={`${
              selectedView !== "report" && "sticky bg-[#fafbfd]"
          ...
          >
            ...
            <p className="font-semibold text-[#8d93bd]">
              ...
              for today, and{" "}
              <span className="bg-[#e3e4ef] rounded text-sm px-2 py-1 text-[#4c5383]">
                {overDueCountResponse?.data?.data?.data?.overdueCount ?? 0}{" "}
                tasks
              </span>{" "}
              are overdue now.
            </p>
            ...
            <div className="project-generic-header flex items-center my-3">
              ...
              >
                <div className="filter-box bg-white rounded-md items-center flex min-[34px]  p-[6px_14px] border border-solid border-[e5e9f1] min-h-[40px] mr-5">
                  ...
                  {/* search  */}
                  <div className="filter-box-search min-w-[180px] flex">
                    <div className="item-icon relative top-[6px] mx-2 text-sm">
                      <svg
                        className="icon "
                        width="1em"
                        height="1em"
                    ...
                    <div className="field-type-text">
                      <input
                        className="field-input focus:outline-none border-none text-[#2f2f2f] text-[14px] p-0"
                        type="text"
                        placeholder="Search..."
                        defaultValue=""
                        value={searchTask}
                ...
                {/* show completed  */}
                <div className="filter-box bg-white rounded-md font-medium items-center flex min-w-[140px] p-[6px_16px] border border-solid border-[e5e9f1] min-h-[40px] cursor-pointer">
                  <div
                    onClick={() => setShowCompleted(!showCompleted)}
                    className="item-label text-[13px] whitespace-nowrap hover:text-[#00a99b] "
                  >
                ...
                {/* end completed  */}
                {/* Group By  */}
                <div className="filter-box bg-white rounded-md items-center flex min-w-[164px] p-[6px_16px] border border-solid border-[e5e9f1] min-h-[40px] cursor-pointer ml-5 hover:text-[#00a99b]">
                  <div className="filter-box-icon relative top-0 mr-2 text-sm">
                    <svg
                      className="icon "
                      width="14px"
                      height="14px"
                  ...
                  <div className="flex">
                    <span
                      className="text-sm font-medium mr-1 min-w-[68px]"
                ...
                <div className="flex flex-1 items-center justify-end">
                  <div
                    className="filter-box bg-white rounded-md items-center flex font-medium text-[14px]
                 border border-solid border-[e5e9f1] min-h-[40px] cursor-pointer ml-5 hover:text-[#00a99b]"
                  >
                    <button
                      className="flex p-[6px_16px]"
                    ...
                    >
                      ...
                      Views
                      <span className="arrow font-bold text-sm ml-2 relative top-[1px]">
                        <svg
                          ...
                          {addNewView ? (
                            <div className="flex flex-col">
                              ...
                              <div className="flex w-[100%] justify-between">
                                <button
                                  className="bg-[#00a99b]  text-[13px] font-medium"
                                  style={{
                                    width: "49%",
                                    padding: "4px",
                                    borderRadius: "6px",
          ...
          {selectedView === "report" ? (
            ...
            <>
              {/* end header part  */}
              <div class="overflow-x-auto customHeight mb-3 mt-3">
                <div class="min-w-[1400px] collapsible-container pr-3">
                  {milestones?.filter((el) => el.tasks.length).length ? (
                        ...
                        return (
                          <>
                            <div className=" tasks-view-section   w-full flex min-h-[1] collapsible-header">
                              {/* overdue  */}
                              <div className="flex items-center bg-[#fafbfd] border border-[#eee] border-b-0 p-[12px] hover:text-[#00a99b] cursor-pointer">
                                <svg
                                  className="icon "
                                  width="1em"
                                  height="0.8125em"
                              ...
                              >
                                <div
                                  className="filter-box bg-white rounded-md rounded-l-none border-l-0 rounded-br-none items-center flex min-[34px]
                      p-[6px_16px] border border-solid border-[e5e9f1] border-b-none h-[42px] cursor-pointer hover:text-[#00a99b] text-[15px] font-medium"
                                >
                              ...
                              {/* // status */}
                              <div className="status_filter w-[11%] text-[15px] font-medium cursor-pointer relative flex p-[10px_13px] h-[42px]  ">
                              ...
                              <div className="status_filter w-[11%] cursor-pointer relative flex p-[10px_13px]  h-[42px]">
                                <div className="table-cell-title text-[15px] font-medium flex hover:text-[#00a99b]">
                                  <span className="icon text-xs relative top-[5px] mr-1">
                                    <svg
                                      className="icon "
                              ...
                              <div className="status_filter w-[11%] cursor-pointer relative flex p-[10px_13px]  h-[42px]">
                                <div className="table-cell-title text-[15px] font-medium flex hover:text-[#00a99b]">
                                  <span className="icon text-xs relative top-[4px] mr-1">
                                    <svg
                                      className="icon "
                                      width="1em"
                                      height="1em"
                    ...
                    p-[4px_7px] border border-solid border-[e5e9f1] border-b-0 h-[28px] cursor-pointer hover:text-[#00a99b]"
                                >
                                  <button
                            ...
                            <div className=" mb-[20px] bg-white overdue_open_section relative border border-solid border-[#e5e9f1]">
                              {el.tasks.length ? (
                                el.tasks.map((elem, taskIndex) => {
                                  console.log(el?.newTask);
                                  return (
                                    openCollapsibles.includes(el.id) && (
                                ...
                                <div className="row-tasks border border-solid border-b border-b-[#e5e9f1] border-l-0 border-r-0 border-t-0">
                                  <div className="flex">
                                    <p className="text-[13px] ml-[20px] font-medium py-1">
                                      No task found
                                    </p>
                                  </div>
                                </div>
                                    ...
                                    <div className="flex justify-between w-full ">
                                      ...
                                      <div className="w-[340px] items-center">
                                        <input
                                          ...
                                          className="border-none bg-transparent w-full h-full text-[15px] font-medium p-[3px]"
                                          name="name"
    ...
    tasks: [
      {
        taskId: 0,
        name: "string",
        dueDate: "2023-06-08T06:24:57.186Z",
        milestoneName: "string",
        noOfComments: 0,
        noOfAttachments: 0,
        picture: {
        ...
        totalSubTasks: 0,
        doneSubTasks: 0,
        completedOn: "2023-06-08T06:24:57.186Z",
        orderIndex: 0,
        assignees: [
          {
            id: 0,
