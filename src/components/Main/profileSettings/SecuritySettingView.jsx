...
const SecuritySettingView = () => {
  ...
  return (
    <div class="cursor-pointer bg-white">
      ...
      <hr></hr>
      <div class="px-11 mt-4 flex flex-col bg-white">
        <div class="mb-5 relative">
          <div>
            ...
            <div className="flex w-[40%] space-x-3">
              ...
              <span class="!border-left-0 text-gray-800 mt-7 bg-[#f7f7f7] font-semibold global-inputFiled text-[12px] px-3 items-center h-[45px] py-2 !border-gray-300 cursor-pointer flex justify-center uppercase ">
                Edit
              </span>
            </div>
          </div>
          ...
          <label class="block mb-1 font-Manrope font-semibold text-[15px] text-[#2f2f2f] mt-9">
            Two Factor Authentication
          </label>
          <p class="mb-4 font-Manrope font-medium text-[15px] text-[#2f2f2f]">
          ...
          <hr class="mt-5 w-[55%] -ml-11"></hr>
          <label class="block mb-2 font-Manrope font-semibold text-[15px] text-[#2f2f2f] mt-6">
            Manage SSO Authentication Methods
          </label>
          <span class="max-w-[350px] min-w-[300px] ">
            <span class="flex text-center border border[#e8e8e8] p-[15px] rounded-md text-base max-w-[350px] min-w-[300px] font-Manrope font-semibold ">
              <svg
          ...
          <span class="max-w-[320px] min-w-[300px] mt-4">
            <span class="flex text-center border border[#e8e8e8] p-[15px] rounded-md text-base font-Manrope font-semibold max-w-[350px] min-w-[300px] mt-4">
              <svg
